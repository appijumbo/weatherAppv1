...
function getLocation(){
    ...
    var options = { enableHighAccuracy: false, timeout: timeOut, maximumAge: maxAge };

    if (navigator.geolocation) {navigator.geolocation.getCurrentPosition(displayPosition,displayError,options);}

    else {

        console.log("**--->  navigator.geolocation error in getLocation ");
        handleErrors("Sorry but you need to update your browser so I can find your location");
    }
...
function displayError(error) {
           ...
           console.log("**--->  displayError error code is = " + errors[error.code]);

           handleErrors("sorry I had trouble getting your location. Try refreshing the browser");
